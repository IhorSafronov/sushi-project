(() => {
    ...
    (() => {
        ...
        let distanceElement;
        let deliveryPrice;
        function calculateDeliveryCost(cartTotal, distanceText) {
            if (cartTotal < 400) return 0; else if (cartTotal >= 400 && cartTotal <= 800) if (parseFloat(distanceText) <= 5) return 0; else return 10 * (parseFloat(distanceText) - 5); else if (parseFloat(distanceText) <= 10) return 0; else return 10 * (parseFloat(distanceText) - 10);
        }
        function initAutocomplete() {
            ...
            autocomplete.addListener("place_changed", (() => {
                ...
                var cartTotal = parseFloat(cartTotalElement.textContent.trim());
                ...
                if (cartTotal > 400) {
                    console.log("Сумма в корзине больше 400грн");
                    ...
                    service.getDistanceMatrix({
                        ...
                        console.log("Сумма в корзине больше 400грн");
                        console.log("Расстояние: " + distanceText);
                        var deliveryCost = calculateDeliveryCost(cartTotal, distanceText);
        ...
        if (window.location.href.includes("cart-page.html")) document.querySelector(".body-bot__cart").style.display = "none";
        window["FLS"] = true;
        isWebp();
        menuInit();
        spollers();
