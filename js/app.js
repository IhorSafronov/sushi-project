(() => {
    ...
    (() => {
        ...
        if (window.location.href.includes("admin.html")) document.getElementById("search-button").addEventListener("click", (function() {
            var searchInput = document.getElementById("search-input").value;
            var formData = JSON.parse(localStorage.getItem("formData")) || [];
            var categoryContainer = document.getElementById("category-container");
            categoryContainer.innerHTML = "";
            var dateFromInput = new Date(document.getElementById("date-from-input").value).toLocaleString("uk-UA");
            var dateToInput = new Date(document.getElementById("date-to-input").value).toLocaleString("uk-UA");
