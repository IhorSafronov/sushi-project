(() => {
    ...
    (() => {
        ...
        window.addEventListener("scroll", (function() {
            ...
            if (scrollTop > 450 && scrollTop > anchorsItems.offsetTop - anchorsItems.offsetHeight) anchorsItems.classList.add("anchors-items--sticky"); else anchorsItems.classList.remove("anchors-items--sticky");
        }));
        ...
        function initAutocomplete() {
            ...
            autocomplete.addListener("place_changed", (() => {
                ...
                service.getDistanceMatrix({
                    ...
                    } else console.log("Сумма в корзине меньше 400грн");
