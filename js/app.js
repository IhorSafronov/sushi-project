            ...
            if ("/cart-page.html" === location.pathname) document.addEventListener("DOMContentLoaded", (function() {
                ...
                form.addEventListener("submit", (function(e) {
                    ...
                    try {
                        ...
                        if (!nameInput || !phoneInput || !addressInput) throw new Error("Не удалось получить элементы формы");
                        const name = nameInput.value;
                        const phone = phoneInput.value;
                        const address = addressInput.value;
                        if (!name || !phone || !address) throw new Error("Не заполнены обязательные поля формы");
